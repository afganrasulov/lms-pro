...
export type UserStreak = any;
export type XpLog = any;
...
export type CourseProgressSummary = any;
...
export type EnrollmentInsert = any;
export type NotificationInsert = any;
...
export type UserStreakInsert = any;
export type XpLogInsert = any;
...
export type EnrollmentUpdate = any;
export type NotificationUpdate = any;
...
export type UserStreakUpdate = any;
export type XpLogUpdate = any;
